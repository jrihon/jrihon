...
local function lsp_keymaps()
  ...
  vim.api.nvim_set_keymap("n", "gD", ":Telescope lsp_declarations<CR>", opts)
  ...
  vim.api.nvim_set_keymap("n", "gl", ":lua vim.diagnostic.open_float()<CR>", opts)
  vim.api.nvim_set_keymap("n", "gs", ":lua vim.lsp.buf.signature_help()<CR>", opts)
  vim.api.nvim_set_keymap("n", "gd", ":lua vim.lsp.buf.definition()<CR>", opts)
  vim.api.nvim_set_keymap("n", "gK", ":lua vim.lsp.buf.hover()<CR>", opts)
